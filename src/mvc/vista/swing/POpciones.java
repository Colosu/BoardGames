...
import mvc.control.ControladorSwing;
import mvc.logica.Ficha;
import mvc.logica.TableroInmutable;
import mvc.logica.Partida.Observer;
...
public class POpciones extends JPanel implements Observer {
	...
	public POpciones(final ControladorSwing controlador) {
		...
		deshacer.setIcon(new ImageIcon("src/mvc/vista/swing/iconos/undo.png"));
		this.add(deshacer);
		...
		reiniciar.setIcon(new ImageIcon("src/mvc/vista/swing/iconos/reiniciar.png"));
		this.add(reiniciar);
	}
